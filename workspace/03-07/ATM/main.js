...
atm.retirar(85);
console.log(atm.cedulas(5) === 9);
console.log(atm.cedulas(10) === 15);
console.log(atm.cedulas(20) === 9);
console.log(atm.cedulas(50) === 16);
atm.retirar(115);
console.log(atm.cedulas(5) === 8);
console.log(atm.cedulas(10) === 14);
console.log(atm.cedulas(100) === 9);
atm.retirar(265);
console.log(atm.cedulas(5) === 7);
console.log(atm.cedulas(10) === 13);
console.log(atm.cedulas(50) === 15);
console.log(atm.cedulas(100) === 7);
atm.retirar(45);
console.log(atm.cedulas(5) === 6);
console.log(atm.cedulas(20) === 7);
